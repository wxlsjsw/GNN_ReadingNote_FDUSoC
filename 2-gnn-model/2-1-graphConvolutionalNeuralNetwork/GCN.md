...
<a href="https://www.codecogs.com/eqnedit.php?latex=H^{l&plus;1}=\sigma&space;(D\widetilde{}^{-\frac{1}{2}})" target="_blank"><img src="https://latex.codecogs.com/gif.latex?H^{l&plus;1}=\sigma&space;(D\widetilde{}^{-\frac{1}{2}})" title="H^{l+1}=\sigma (D\widetilde{}^{-\frac{1}{2}})" /></a>
## Loss
